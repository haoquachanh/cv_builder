...
export const PRIMARY_COLORS = [
  ...
  { label: "Xám", value: "#4b5563" },
  { label: "Teal", value: "#0d9488" },
  { label: "Chàm", value: "#4f46e5" },
] as const;
...
export const BACKGROUND_COLORS = [
  ...
  { label: "Xám mát", value: "#f1f5f9" },
  { label: "Xám ấm", value: "#f5f5f4" },
  { label: "Xanh nhạt", value: "#f0f9ff" },
  { label: "Xanh lá nhạt", value: "#f0fdf4" },
] as const;
...
export const TEXT_DECORATIONS = [
  { label: "Không", value: "none" },
  { label: "Gạch chân", value: "underline" },
] as const;
